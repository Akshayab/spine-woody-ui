    ...
    projects: [
      {
        ...
        status: 'on-track',
        milestones: [
          { id: 'w-p1-m1', label: 'Exhibitor list analyzed', teamIds: ['w-market-research'], status: 'done' },
          { id: 'w-p1-m2', label: 'Competitor expo strategy mapped', teamIds: ['w-competitor-watch'], status: 'in-progress' },
          { id: 'w-p1-m3', label: 'Marketing materials drafted', teamIds: ['w-content-marketing'], status: 'in-progress' },
          { id: 'w-p1-m4', label: 'Booth talking points finalized', teamIds: ['w-market-research', 'w-content-marketing'], status: 'pending' },
      ...
      },
      {
        ...
        status: 'on-track',
        milestones: [
          { id: 'w-p2-m1', label: 'Pricing benchmarks completed', teamIds: ['w-market-research'], status: 'done' },
          { id: 'w-p2-m2', label: 'Email campaign drafted', teamIds: ['w-content-marketing'], status: 'done' },
          { id: 'w-p2-m3', label: 'Social content calendar ready', teamIds: ['w-content-marketing'], status: 'in-progress' },
          { id: 'w-p2-m4', label: 'Distributor outreach prep', teamIds: ['w-market-research', 'w-content-marketing'], status: 'pending' },
        ],
        personaId: 'woody',
    ...
    projects: [
      {
        ...
        status: 'on-track',
        milestones: [
          { id: 's-p1-m1', label: 'RFP requirements analyzed', teamIds: ['s-business-dev'], status: 'done' },
          { id: 's-p1-m2', label: 'Ministry background research', teamIds: ['s-business-dev'], status: 'done' },
          { id: 's-p1-m3', label: 'NovaPharma experience packaged', teamIds: ['s-novapharma', 's-business-dev'], status: 'in-progress' },
          { id: 's-p1-m4', label: 'Proposal draft v1', teamIds: ['s-business-dev'], status: 'in-progress' },
      ...
      },
      {
        ...
        status: 'on-track',
        milestones: [
          { id: 's-p2-m1', label: 'Market entry analysis complete', teamIds: ['s-greenbuild'], status: 'done' },
          { id: 's-p2-m2', label: 'Partner shortlist finalized', teamIds: ['s-greenbuild'], status: 'done' },
          { id: 's-p2-m3', label: 'Financial projections updated', teamIds: ['s-greenbuild'], status: 'done' },
          { id: 's-p2-m4', label: 'Strategy deck v3 complete', teamIds: ['s-greenbuild'], status: 'done' },
    ...
    projects: [
      {
        ...
        status: 'at-risk',
        milestones: [
          { id: 'm-p1-m1', label: 'Competitive gap analysis', teamIds: ['m-competitive-intel'], status: 'done' },
          { id: 'm-p1-m2', label: 'User demand quantified', teamIds: ['m-user-research'], status: 'done' },
          { id: 'm-p1-m3', label: 'Churn impact assessed', teamIds: ['m-user-research'], status: 'done' },
          { id: 'm-p1-m4', label: 'Partnership options evaluated', teamIds: ['m-competitive-intel', 'm-user-research'], status: 'in-progress' },
          { id: 'm-p1-m5', label: 'Legal review cleared', status: 'pending' },
          { id: 'm-p1-m6', label: 'Stakeholder deck presented', teamIds: ['m-stakeholder-updates', 'm-competitive-intel', 'm-user-research'], status: 'pending' },
        ],
        personaId: 'marcus',
      ...
      },
      {
        ...
        status: 'on-track',
        milestones: [
          { id: 'm-p2-m1', label: 'Impact analysis complete', teamIds: ['m-competitive-intel'], status: 'done' },
          { id: 'm-p2-m2', label: 'Scenario models built', teamIds: ['m-competitive-intel'], status: 'in-progress' },
          { id: 'm-p2-m3', label: 'Customer impact assessed', teamIds: ['m-competitive-intel', 'm-user-research'], status: 'pending' },
          { id: 'm-p2-m4', label: 'Pricing decision made', status: 'pending' },
          { id: 'm-p2-m5', label: 'Stakeholder communication', teamIds: ['m-stakeholder-updates'], status: 'pending' },
        ],
        personaId: 'marcus',
